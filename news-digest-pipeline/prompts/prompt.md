...
В каждом отдельном комментарии к новости должна быть умеренная нецензурная лексика: 2-3 прямых матерных или грубых разговорных оборота на пункт.
Мат должен звучать как живой авторский стиль, а не как самоцель.
...
Мат: в каждом комментарии должно быть 2-3 прямых матерных или грубых слова/оборота, если тема это выдерживает. Можно использовать: блядь, хер, хуйня, пиздец, нахрен, ебаный, заебали. Не используй угрозы, травлю и оскорбления по защищенным признакам.
