...
function buildConfig() {
  ...
  return {
    ...
    appleArticlesPerDigest: parseInt(process.env.APPLE_ARTICLES_PER_DIGEST || '0', 10),
    ...
    rssMaxArticlesPerSource: parseInt(process.env.RSS_MAX_ARTICLES_PER_SOURCE || '2', 10),
    rssRecoveryMaxArticleAgeHours: parseInt(process.env.RSS_RECOVERY_MAX_ARTICLE_AGE_HOURS || '120', 10),
    rssRecoveryMaxArticlesPerSource: parseInt(process.env.RSS_RECOVERY_MAX_ARTICLES_PER_SOURCE || '2', 10),
